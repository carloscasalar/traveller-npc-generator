...
func TestRole_Given_Recruit_NPC(t *testing.T) {
	tests := []struct {
		...
		{npc.RoleMarine, []string{"Gun Combat-0", "Survival-0", "Athletics-0", "Melee-0"}},
...
func TestRole_Given_Rookie_NPC(t *testing.T) {
	tests := []struct {
		...
		{npc.RoleMarine, []string{"Gun Combat-1", "Survival-1", "Athletics-0", "Melee-0", "Heavy Weapons-0", "Tactics-0"}},
...
func TestRole_Given_Intermediate_NPC(t *testing.T) {
	tests := []struct {
		...
		{npc.RoleMarine, []string{"Gun Combat-2", "Survival-1", "Athletics (Strength)-1", "Melee-0", "Heavy Weapons-0", "Tactics-0", "Recon-0"}},
...
func TestRole_Given_Regular_NPC(t *testing.T) {
	tests := []struct {
		...
		{npc.RoleMarine, []string{"Gun Combat-2", "Survival-2", "Athletics (Strength)-1", "Melee (Unarmed)-1", "Heavy Weapons-0", "Tactics-0", "Recon-0", "Sensors-0", "Leadership-0"}},
...
func TestRole_Given_Veteran_NPC(t *testing.T) {
	tests := []struct {
		...
		{npc.RoleMarine, []string{"Gun Combat-2", "Survival-2", "Athletics (Strength)-2", "Melee (Unarmed)-1", "Heavy Weapons-1", "Tactics-0", "Recon-0", "Sensors-0", "Leadership-0", "Medic-0"}},
...
func TestRole_Given_Elite_NPC(t *testing.T) {
	tests := []struct {
		...
		{npc.RoleMarine, []string{"Gun Combat-3", "Survival-2", "Athletics (Strength)-2", "Melee (Unarmed)-1", "Heavy Weapons-1", "Tactics (Military)-1", "Recon-0", "Sensors-0", "Leadership-0", "Medic-0", "Piloting-0", "Communications-0"}},
